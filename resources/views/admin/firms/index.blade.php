        ...
        <div class="col-md-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('admin.users.create') }}" class="btn btn-primary btn-success">@lang('modules.users.createNewUser') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="firms-table" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                            <thead>
                            <tr>
                                <th>id</th>
                                <th>name</th>
                                <th>Region Finance Office</th>
                                <th>Tax Number</th>
                                <th>phone</th>
                                <th>action</th>
...
@push('footer-script')
    ...
    <script>
        $(function() {
            var table = $('#firms-table').dataTable({
                paging    : true,
                responsive: true,
                processing: true,
                serverSide: true,
                ...
                columns: [
                    ...
                    { data: 'region_finance_office', name: 'region_finance_office' },
