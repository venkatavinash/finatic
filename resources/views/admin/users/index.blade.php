        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="users-table" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
                            <thead>
                            <tr>
                                <th>id</th>
                                <th>name</th>
    ...
    <script>
        $(function() {
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    title: "Are you sure?",
                    text: "You will not be able to recover the deleted user! This will delete all the data accociated with the user.",
                    type: "warning",
